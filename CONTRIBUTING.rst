...
It might be that we are already working on the same or similar change, but we
have not made our work visible yet.

.. _create a new issue: https://github.com/aas-core-works/aas-core-meta/issues/new/choose
